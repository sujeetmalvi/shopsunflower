  ...
  public function create_user() {
   ...
   public function create_shop() {
    ...
    public function product_stock(){
        ...
        $result = array();
        $product_query = $this->db->query("SELECT ProductId, DesigneCode,SUM(ProductQty) as ProductQty,ColourMaster.id as ColourId, ColourMaster.ColourName,SizeMaster.id as SizeId,SizeMaster.SizeCode,IsOffer,OfferPrice,OfferPercent 
                                            FROM `ProductStock` 
