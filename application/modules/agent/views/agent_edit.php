        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="form_agent_update"  action="javascript:;" method="POST">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input id="AgentName" name="AgentName" type="text" class="form-control required" value="<?php echo $details['AgentName'];?>">
                            </div>

                            <div class="form-group col-lg-12">
                                <input type="hidden" id="<?=$csrfName;?>" name="<?=$csrfName;?>" value="<?=$csrfHash;?>" />
                                <input type="hidden" name="AgentId"  value="<?php echo $details['id'];?>">
