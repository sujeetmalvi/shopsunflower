...
<div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins" id="print_table" >
                    <div class="ibox-title">
                        ...
                        <div class="row">
                        	<div class="col-xs-12"><b>Stockist Name:-</b><?php echo $data['User']['StockistName'];?></div>
                        </div>
                        <div class="row">
						...
						<div class="row">
							...
							<div class="col-xs-4"><b>Order Date. :- </b><?php echo date('d-m-Y',strtotime($data['summary'][0]['OrderDate']));?>
							</div>
							<div class="col-xs-4"><b>Company Name :-  </b><?php echo COMPANYNAME;?></div>
			...
			//$stockist_purchase_rate = sprintf('%0.2f', $order['ProductPurchaseRate']+(($order['ProductPurchaseRate']*$order['PTSMargin'])/100));
			$stockist_purchase_rate =$order['ProductPurchaseRate'];
			
			
									$amount = sprintf('%0.2f', $stockist_purchase_rate*$order['OrderQuantity']);

								echo "<tr>
									<td>".$i."</td>
									<td>".$order['ProductName']."</td>
									
									<td>".$stockist_purchase_rate."</td>
