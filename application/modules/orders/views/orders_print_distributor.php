            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins" id="print_table" >
                    <div class="ibox-title">
                        ...
                        <div class="row">
                        	<div class="col-xs-12"><b>Distributor Name:-</b><?php echo $data['User']['DistributorName'];?></div>
                        </div>
                        <div class="row">
						...
						<div class="row">
							...
							<div class="col-xs-4"><b>Company Name :- </b></div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
								...
								foreach($data['details'] as $order){
									...
									$distributor_purchase_rate = sprintf('%0.2f', $order['PurchaseRate']+(($order['PurchaseRate']*$order['PTDMargin'])/100));
									$amount = sprintf('%0.2f', $distributor_purchase_rate*$order['OrderQuantity']);

								echo "<tr>
									<td>".$i."</td>
									<td>".$order['ProductName']."</td>
									<td>".$order['Composition']."</td>
									<td>".$distributor_purchase_rate."</td>
									<td>".$order['MrpRate']."</td>
