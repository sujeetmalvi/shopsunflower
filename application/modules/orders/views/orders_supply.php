        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="form_orders_supply_save"  action="javascript:;" method="POST">
                    ...
                    ?>
                                ...
                                <select id="CustomerId" name="RetailerId" class="form-control">
                                <option>Select Retailer</option>
                                <?php  if(!empty($customer_list)){ 
                                		foreach($customer_list as $list){
                                ?>
                                    <option value="<?php echo $list['id']; ?>"><?php echo $list['RetailerName']; ?></option>
                                 <?php } 
                                 } 
                                 ?>
                      ...
                      if($_SESSION['user_role']=='admin'){
                        ...
                        ?>
                        	<label>Stockist*</label>
                        	 <select id="CustomerId" name="StockistId" class="form-control">
                        	 <option>Select Stockist</option>
                                 <?php  if(!empty($customer_list)){ 
                                		foreach($customer_list as $list){
                                ?>
                                    <option value="<?php echo $list['id']; ?>"><?php echo $list['StockistName']; ?></option>
                                 <?php } 
                                 } 
                                 ?>
                                </select>
                        <?php } ?>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                        ...
                                        <input id="ProductName1" class="form-control" placeholder="Type product name">
                                </div>
                                <div class="col-md-6">
                                        <label>Date *</label>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="submit"  name="submit" type="button" class="btn btn-primary pull-right" value="Save" onclick="form_orders_supply_save()" >
                                </div>
                        </div>
                    </form>
                </div>
