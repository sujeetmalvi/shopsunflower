        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="form_Barcode_save"  action="<?php echo 'barcode/generate'; ?>" method="POST">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                    <option value="<?php echo $product['Batch']; ?>"><?php echo $product['ProductName'].'(B:N -' .$product['Batch'].')'; ?>
                                    </option>
                                <?php } ?>
                                </select>
                            </div>
