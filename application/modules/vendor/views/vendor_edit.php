        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="form_vendor_update"  action="javascript:;" method="POST">
                        <div class="row">
                        <div class="form-group">
                                <label>Vendor Name *</label>
                                <input id="VendorName" name="VendorName" type="text" class="form-control required" value="<?php echo $details['VendorName'];?>">
                            </div>
				 <div class="form-group">
                                    <label>Vendor Contact No *</label>
                                    <input id="VendorContactNo" value="<?php echo $details['VendorContactNo'];?>" name="VendorContactNo" type="text" class="form-control required">
                                </div>

                                <div class="form-group">
                                    <label>Vendor Email </label>
                                    <input id="VendorEmail" value="<?php echo $details['VendorEmail'];?>" name="VendorEmail" type="text" class="form-control required">
                                     <input id="VendorId" value="<?php echo $details['id'];?>" name="VendorId" type="hidden" class="form-control required">
                                </div>
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="hidden" name="VendorId"  value="<?php echo $details['id'];?>">
