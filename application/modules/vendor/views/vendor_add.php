        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="form_vendor_save"  action="javascript:;" method="POST">
                        <div class="row">

                                <div class="form-group">
                                    <label>Vendor Name *</label>
                                    <input id="VendorName" name="VendorName" type="text" class="form-control required">
                                </div>

                                <div class="form-group">
                                    <label>Vendor Contact No *</label>
                                    <input id="VendorContactNo" name="VendorContactNo" type="text" class="form-control required">
                                </div>

                                <div class="form-group">
                                    <label>Vendor Email </label>
                                    <input id="VendorEmail" name="VendorEmail" type="text" class="form-control required">
                                </div>
