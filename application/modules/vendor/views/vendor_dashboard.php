    ...
    <div class="row">
        <div class="col-lg-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <h5>Total Retailers</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins"><?php echo $total_retailers; ?></h1>
        ...
        <div class="col-lg-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-success pull-right">Today</span> 
                    <h5>Recurring Retailers</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins"><?php echo $recurring_retailers; ?></h1>
                    <small>Recurring REtailers</small>
                </div>
            </div>
        </div>
        <div class="col-lg-3">
