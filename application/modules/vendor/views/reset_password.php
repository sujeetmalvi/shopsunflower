...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            <div>
                <h3 class="logo-name"><?php echo 'Password Reset'; ?></h3>
            </div>           
            <h5> Forget Password Reset</h5>
             <h5 style="color:red"><?php echo (isset($error_msg))?$error_msg:'';?></h5>
            <form class="form-horizontal form-material" id="resetpasswordform" method="POST" action="javascript:;">
                <div class="form-group">
                   <input type="password" onblur="check_password()" name="password" id="password" class="form-control" placeholder="Enter Password" required="" value="">
                </div>  
                <div class="form-group">
                    <input type="password" onblur="check_password()" name="newpassword" id="newpassword" class="form-control" placeholder="Enter New Password" required="" value="">
                    <input type="hidden" name="forgetpassword_code" value="<?php echo $code; ?>" >
