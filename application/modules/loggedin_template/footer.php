    ...
    if (window.File && window.FileList && window.FileReader) {
      ...
      alert("Your browser doesn't support to File API")
            ...
            elem.forEach(function(html) {
                var switchery = new Switchery(html, { size: 'small',color: '#1AB394' });
            });
...
<div id="LoadingModal" class="modal" data-easein="flipXIn"  data-backdrop="static"  tabindex="-1" role="dialog" aria-labelledby="costumModalLabel" aria-hidden="true">
  <div class="modal-dialog" style="width: 160px;">
    <div class="modal-content" >
      <div class="modal-body">
      Please Wait ...
      <br>
          <img src="<?php echo base_url('assets/img/logo.gif');?>" align="center"/>
      </div>
    </div>
  </div>
</div>
