                    ...
                    <form id="form_gst_update" action="javascript:;" method="POST">
                        <div class="row">
                                    ...
                                    <label>Gst Type</label>
                                     <select name="GstType" id="GstType" class="form-control" >					 
                                        <option value="">Select Type</option>                                      
                                            <option value="1" <?php if($details['GstType']==1){ echo "selected"; }  ?>>Purchase
                                            </option>										
								...
								<div class="form-group">
                                    ...
                                    <input name="GstApply" value="<?php echo $details['GstApply'];?>" type="text" placeholder="Enter Apply" id="GstApply" class="form-control required">
                                </div>
