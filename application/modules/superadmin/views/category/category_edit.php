        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="form_category_update" action="javascript:;" method="POST">
                        <div class="row">

                                <div class="form-group">
                                    <label>Category Name *</label>
                                    <input id="CategoryName" value="<?php echo $details['CategoryName'];?>" name="CategoryName" type="text" class="form-control required">
                                </div>
