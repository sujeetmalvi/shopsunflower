...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <form class="form-horizontal form-material" id="loginform" method="POST" action="<?php echo site_url('distributor/distributor/distributor_login');?>">
                <div class="form-group">
                    <input type="email" name="loginname" class="form-control" placeholder="Username" required="" value="distributor@admin.com">
                </div>
                <div class="form-group">
