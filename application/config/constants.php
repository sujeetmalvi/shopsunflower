...
define('SITE_TITLE','Sunflower');

define('LOGIN_PAGE_TITLE','Sunflower');

define('COPYRIGHT_TEXT','Copyright '.date('Y').'. All rights reserved.<br>Designed and Developed by <br>Melhor Technologies ');

define('COMPANYNAME','Sunflower');
...
$_SERVER['ORDERTYPE'] = ARRAY('1'=>'READY-STOCK','2'=>'PRE-ORDER','3'=>'CUSTOM-ORDER');

// $_SERVER['FINANCIAL_TYPE']  = ARRAY('1'=>'Income','2'=>'Expense');
// $_SERVER['ACCOUNT_TYPE']  = ARRAY('1'=>'Saving','2'=>'Current');
// $_SERVER['GENDER']  = ARRAY('0'=>'Male','1'=>'Female','3'=>'Not Applicable');
// $_SERVER['MARITAL_STATUS']  = ARRAY('0'=>'Un-Married','1'=>'Married','2'=>'Divorced','3'=>'Seperated' , '4' =>'Widowed','5'=>'Not Applicable');
// $_SERVER['ACTIVE_DEACTIVE']  = ARRAY('0'=>'Active','1'=>'Deactive');
